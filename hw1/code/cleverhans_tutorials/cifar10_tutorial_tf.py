...
def cifar10_tutorial(train_start=0, train_end=60000, test_start=0,
  ...
  if clean_train:
    ...
    for i in range(30):
      ...
      true_label, adv_label = CIFAR10.LABEL_NAMES[y_true_label], CIFAR10.LABEL_NAMES[y_adv_label]
      
      plt.subplot(1,3,1)
      plt.title("Original : {}".format(true_label))
      plt.imshow(ori_images[:,:,0])

      plt.subplot(1,3,2)
      plt.title('Adversarial : {}'.format(adv_label))
